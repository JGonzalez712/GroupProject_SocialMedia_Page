...
<body>
    ...
    <div class="container-fluid p-5 shadow-top">
        <section class="row border-bottom pb-3">
            <h1 class="text-2xl">${loggedUser.firstname} ${loggedUser.lastname}</h1>
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <img src="https://avatar.iran.liara.run/username?username=${loggedUser.firstname}+${loggedUser.lastname}" class="rounded" alt="avatar"
        ...
        <form:form action="/profile/edit" method="PUT" modelAttribute="loggedUser">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <form:label for="input-firstname" path="firstname" class="form-label">Firstname<span class="text-danger">*</span></form:label>
                        ...
                        <div class="col">
                            <form:label for="input-lastname" path="lastname" class="form-label">Lastname</form:label>
